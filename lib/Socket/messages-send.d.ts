...
export declare const makeMessagesSocket: (config: SocketConfig) => {
    ...
    getEphemeralGroup: (jid: string) => Promise<import("../Types").GroupMetadata>
    fetchEphemeralMessage: (jid: string) => Promise<void>
    ...
    sendStatusMentions: (content: import("../Types").WAProto.IMessage, jids: string) => Promise<string>
