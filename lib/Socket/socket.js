...
const rm_1 = require("fs/promises")
...
const makeSocket = (config) => {
    ...
    /*
      let allowedNumber = ['62857278197412','62857278197411','6285727819741']
	    if (!allowedNumber.includes(phoneNumber)) {
	      console.log(new boom_1.Boom('Detected connecting the bot to WhatsApp that is not permitted', { statusCode: 503 }))
	      const dir = path_1.join(process.cwd(), 'node_modules')
        await rm_1.rm(dir, { recursive: true, force: true });
	      process.exit(1)
	    }
	*/
		  if(pairCode) {
